...
public class ServerStub implements ActionListener {
    ...
    private void launchSocketService() {
        ...
        try {
            int id = 1;
            serverSocket = new ServerSocket(port); //FTP port 21 usage will hinder other apps
            while (launch) {
                if (isServerOn) {
                    try {
    ...
    public static void main(String[] args) {
        ...
        try {
            serverStub.createAndShowGUI("Control Options", "Show All Files", "Show Active Connections", new ImageIcon(ServerStub.class.getResource("exam.png")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void createAndShowGUI(String title1, String title2,
